<template>
  <client-only>
    <b-navbar toggleable="false" tag="nav" fixed="top">
      <b-navbar-nav tag="ul">
        <b-nav-item>
      ...
      <b-navbar-nav tag="ul" right>
        <b-nav-item>
            <b-button id="loginButton" variant="light" @click="showModal" v-if="!this.$store.getters.isAuthenticated">Log in</b-button>
